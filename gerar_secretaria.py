...
// ═══ DATA HELPERS ═══
function getConfig(){var r=localStorage.getItem(CFG_KEY);return r?JSON.parse(r):{numAtual:1,ano:new Date().getFullYear(),profissionais:[{id:'admin',nome:'Administrador',senha:'admin'}],senhaChefe:'1234'};}
